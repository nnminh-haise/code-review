...
/**
 * * Class Task ổn, format đẹp (chắc rút kinh nghiệm từ project trước =)))
 * 
 * * Song, nên tách biệt hai class Date và Task ra ngoài
 * ! Chưa có giá trị mặc định cho hai field status và priority
*/
class Task {
public:
    enum Status {
    ...
    /**
     * ! Các hàm liên quan đến Date nên được viết trong class Date và được tách thành một module riêng
    */
    struct Date {
        int day;
        int month;
