...
/**
 * ? Nếu người dùng muốn sắp xếp theo ngày tạo Task?
*/
...
// ? Comment có 5 fields nhưng code có 4 fields? Nhưng ý nghĩa của a là gì?
...
/**
 * ! Do thiết kế của a ban đầu chưa hợp lí nên quá trình ghi file không quá tối ưu.
*/
void writeToTxt() {
    clearOutputFile();
    int count = 0;
...
/**
 * ? Tại sao chức năng tìm kiếm lại cho người dùng tạo lại một Task mới chỉ để tìm kiếm?
 * ! Không cần thiết tích hợp chức năng sửa và xoá Task vào chức năng tìm kiếm. Nên tách riêng và gọi khi cần.
 * ! Nếu có nhiều Task trùng thông tin sẽ chỉ in được một Task duy nhất.
*/
void findTask() {
    system("cls");
